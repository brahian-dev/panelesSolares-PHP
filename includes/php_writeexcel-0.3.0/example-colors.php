...
$fname = tempnam("C:\Documents and Settings\fernando\Mis documentos\COLORS.XLS", "FF");
...
$worksheet3 =& $workbook->addworksheet('EL DE MODA ES UN GAY');

$worksheet3->write(0, 0, "ZUNGA", $heading);
$worksheet3->write(0, 1, "ZANGANA", $heading);
$worksheet3->write(0, 2, "PERRO", $heading);
$worksheet3->write(0, 3, "GAY",  $heading);
